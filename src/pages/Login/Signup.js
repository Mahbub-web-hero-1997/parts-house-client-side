    ...
    return (
        <div className='h-screen w-1/3 mx-auto my-5'>
            <form className='flex flex-col items-center justify-center mx-auto mt-20 rounded-xl shadow-2xl p-10' onSubmit={handleSubmit(onSubmit)}>
                ...
                <p className='text-left'>Already have an account? <Link className='text-blue-500' to='/login'>Please Login!</Link></p>
                <input className=' btn border w-full my-2 rounded-sm shadow-lg py-2 px-4 outline-none uppercase text-base' type="submit" value='Signup' />
            </form>
